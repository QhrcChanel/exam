...
<html lang="en">
	...
	<body class="no-skin">
					...
					<div class="page-content">
						...
						<form class="form-horizontal" role="form">
							<div class="form-group">
								<label class="col-sm-1 control-label no-padding-right" for="form-field-1-1"> 考试标题 </label>

								<div class="col-sm-2">
									<input type="text" id="examTitle" class="form-control" />
								</div>
								&emsp;&emsp;&emsp;
								<label class="col-sm-1 control-label no-padding-right" for="form-field-1">考试时间 </label>
		...
		<script src="./js/question/examList.js"></script>
 	</body>
</html>
